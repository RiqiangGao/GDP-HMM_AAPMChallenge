...
- The scorecard used in the evaluation has been adjusted from Varian Medical Affairs website. we modify the scorecard by assigning large penalty weights to items that do not meet the quality criteria, in order to better align with our iterative optimization pipeline. Also, we did not include the naming miss-matched items. 
